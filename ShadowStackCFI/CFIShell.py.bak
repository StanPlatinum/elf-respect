...
print("shell: " + "mkdir " + codeDir + codeName + " :\n")
...
#llvm
print("shell: " + llvmBinDir + "clang -emit-llvm -S " + codePath + " :\n")
print(subprocess.call(llvmBinDir + "clang -emit-llvm -S " + codePath, shell=True))

print("shell: " + llvmBinDir + "clang -emit-llvm -S " + CFISrcPath + " :\n")
print(subprocess.call(llvmBinDir + "clang -emit-llvm -S " + CFISrcPath, shell=True))

print("shell: " + llvmBinDir + "llvm-link " + CFISrcDir + CFISrcName + ".ll " + codeDir + codeName + ".ll -S -o " + linkPath + " :\n")
print(subprocess.call(llvmBinDir + "llvm-link " + CFISrcDir + CFISrcName + ".ll " + codeDir + codeName + ".ll -S -o " + linkPath, shell=True))

chanegSrcFileName(linkPath, "llvm-link", codeName)

print("shell: " + llvmBinDir + "opt -load " + llvmPassPath + " -cfihello -S <" + linkPath + "> " +optPath + " :\n")
print(subprocess.call(llvmBinDir + "opt -load " + llvmPassPath + " -cfihello -S <" + linkPath + "> " +optPath, shell=True))

print("shell: " + llvmBinDir + "llc " + optPath + " :\n")
print(subprocess.call(llvmBinDir + "llc " + optPath, shell=True))

mergeEntryName(codeDir + codeName + ".txt", entryLabelPath)