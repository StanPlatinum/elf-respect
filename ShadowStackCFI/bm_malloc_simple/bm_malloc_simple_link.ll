; ModuleID = 'bm_malloc_simple'
source_filename = "bm_malloc_simple"
...
entry:
  ...
  %call = call noalias i8* @malloc(i64 128) #5
  store i8* %call, i8** %buf, align 8
  %call1 = call i32 @puts(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0))
