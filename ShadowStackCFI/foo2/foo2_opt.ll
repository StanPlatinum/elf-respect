...
@.str.10 = private unnamed_addr constant [29 x i8] c"----------1 in fun----------\00", align 1
@.str.1.11 = private unnamed_addr constant [22 x i8] c"----------1----------\00", align 1
@.str.2.12 = private unnamed_addr constant [22 x i8] c"----------2----------\00", align 1
@.str.3.13 = private unnamed_addr constant [22 x i8] c"----------3----------\00", align 1
@.str.4.14 = private unnamed_addr constant [22 x i8] c"----------4----------\00", align 1
@.str.5.15 = private unnamed_addr constant [9 x i8] c"success!\00", align 1
...
entry:
  %call = call i32 @puts(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.10, i64 0, i64 0))
  ret i32 1
}
...
entry:
  ...
  %call = call i32 @puts(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.1.11, i64 0, i64 0))
  %0 = load i32 ()*, i32 ()** %fp, align 8
  call void @CFICheck(i64 1229782938247303441)
  %call1 = call i32 %0()
  store i32 %call1, i32* %b, align 4
  %call2 = call i32 @puts(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.2.12, i64 0, i64 0))
  %1 = bitcast [8 x i8]* %i_b to i8*
  store i8* %1, i8** %ii_b, align 8
  %call3 = call i32 @puts(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.3.13, i64 0, i64 0))
  %2 = load i32, i32* %b, align 4
  %conv = sext i32 %2 to i64
  %3 = load i8*, i8** %ii_b, align 8
  %call4 = call i8* @my_itoa(i64 %conv, i8* %3, i64 10)
  store i8* %call4, i8** %ii_b, align 8
  %call5 = call i32 @puts(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.4.14, i64 0, i64 0))
  %4 = load i8*, i8** %ii_b, align 8
  %call6 = call i32 @puts(i8* %4)
  %call7 = call i32 @puts(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.5.15, i64 0, i64 0))
