            ...
            )
{
	...
	//PrintDebugInfo("seq_1 in nw_align: %s\n", seq_1);
	//PrintDebugInfo("seq_2 in nw_align: %s\n", seq_2);
	//PrintDebugInfo("seq_1_al in nw_al: %s\n", seq_1_al);
	//PrintDebugInfo("seq_2_al in nw_al: %s\n", seq_2_al);
	...
	//PrintDebugInfo("seq_1_al in the mid of nw_al: %s\n", seq_1_al);
	//PrintDebugInfo("seq_2_al in the mid of nw_al: %s\n", seq_2_al);
        
	while( i > 0 || j > 0 )
        {
		//PrintDebugInfo("in the while i or j > 0\n");
		//PrintDebugInfo("traceback_ij in loop: %c\n", traceback[i][j]);
		...
		//PrintDebugInfo("seq_1_al: %s\n", seq_1_al);
		//PrintDebugInfo("seq_2_al: %s\n", seq_2_al);
        }

	//PrintDebugInfo("seq_1_al in the end of nw_al: %s\n", seq_1_al);
	//PrintDebugInfo("seq_2_al in the end of nw_al: %s\n", seq_2_al);
      ...
      )
{
	...
	// Create alignment
        ...
        #if NW_DEBUG
            PrintDebugInfo("traceback[0][0]: %c\n", traceback[0][0]);
	    PrintDebugInfo("after nw_align, seq_1_al: %s\n", seq_1_al);
	    PrintDebugInfo("after nw_align, seq_2_al: %s\n", seq_2_al);

            int  L_al = strlen(seq_1_al);
            PrintDebugInfo("Length after alignment: %d\n", L_al);
        #endif
	...
	/* De-init */
	PrintDebugInfo("start to De-initialization...\n");
	PrintDebugInfo("Oh in an enclave, no need to do it...\n");
