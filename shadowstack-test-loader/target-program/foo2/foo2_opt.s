...
# %bb.0:                                # %entry
	...
	popq	%rbx
	movq	%rax, -16(%rbp)
	movabsq	$.L.str.4.14, %rdi
	callq	puts
	movq	-16(%rbp), %rdi
	callq	puts
	movabsq	$.L.str.5.15, %rdi
	callq	puts
	xorl	%edi, %edi
	callq	exit
.LBB2_1:
...
.L.str.1.11:
	...
	.type	.L.str.2.12,@object     # @.str.2.12
.L.str.2.12:
	.asciz	"----------2----------"
	.size	.L.str.2.12, 22

	.type	.L.str.3.13,@object     # @.str.3.13
.L.str.3.13:
	.asciz	"----------3----------"
	.size	.L.str.3.13, 22
