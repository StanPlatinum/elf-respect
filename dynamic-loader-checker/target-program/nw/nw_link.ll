...
sw.epilog:                                        ; preds = %sw.bb11, %sw.bb10, %sw.bb9, %sw.bb, %for.body7
...
sw.epilog20:                                      ; preds = %sw.bb19, %sw.bb18, %sw.bb17, %sw.bb16, %sw.epilog
...
sw.epilog101:                                     ; preds = %sw.bb91, %sw.bb74, %sw.bb65, %while.body
...
for.end:                                          ; preds = %for.cond
  ...
  %call12 = call noalias i8* @malloc(i64 %mul11) #6
...
for.body17:                                       ; preds = %for.cond14
  ...
  %call20 = call noalias i8* @malloc(i64 %mul19) #6
...
!0 = !{!"clang version 9.0.0 (https://github.com/StanPlatinum/llvm-project.git 3a49d86ed12106d3767eefb5ff6d90f98867f42f)"}
