...
.LBB0_2:                                # %if.else
	...
	movq	%rax, %r15
	callq	transactionBegin
	callq	wrapper_by_compiler_exit@PLT
	xend
	movq	%r15, %rax
	movq	%rax, %r15
	callq	transactionBegin
...
.Lfunc_end1:
	.size	enclave_main, .Lfunc_end1-enclave_main
                                        # -- End function
	.globl	wrapper_by_compiler_exit # -- Begin function wrapper_by_compiler_exit
	.p2align	4, 0x90
	.type	wrapper_by_compiler_exit,@function
wrapper_by_compiler_exit:               # @wrapper_by_compiler_exit
# %bb.0:                                # %entry
	xend
	movq	%r15, %rax
	movabsq	$3458764513820540927, %r11 # imm = 0x2FFFFFFFFFFFFFFF
...
.LBB2_3:                                # Label of block must be emitted
	...
	callq	exit
.Lfunc_end2:
	.size	wrapper_by_compiler_exit, .Lfunc_end2-wrapper_by_compiler_exit
                                        # -- End function
...
.LBB3_1:                                # Label of block must be emitted
	...
	movl	$4294967295, %edi       # imm = 0xFFFFFFFF
	callq	exit
.LBB3_2:                                # Label of block must be emitted
	movl	$4294967295, %edi       # imm = 0xFFFFFFFF
	callq	exit
.LBB3_3:                                # Label of block must be emitted
	...
	callq	exit
.Lfunc_end3:
	.size	wrapper_by_compiler_puts, .Lfunc_end3-wrapper_by_compiler_puts
                                        # -- End function
