...
sgx_status_t ecall_test_capstone_iter(sgx_enclave_id_t eid);
sgx_status_t secure_timer(sgx_enclave_id_t eid);
sgx_status_t main_ssa_init(sgx_enclave_id_t eid);
